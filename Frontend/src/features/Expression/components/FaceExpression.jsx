    ...
    return (
        <div className="w-full h-full flex flex-col items-center gap-4 relative bg-white px-7 pb-5 rounded-4xl overflow-hidden  ">
            <div className="w-full bg-white flex items-center justify-between py-3 z-2">
                ...
                <div className="py-1 px-2 rounded hidden lg:block bg-gray-700/10 text-sm font-bold text-black/50">
            ...
            <div className="w-fit h-fit relative -mt-10">
                ...
                <div className="text-center w-3/4 lg:absolute left-0 bottom-7 bg-white py-3 px-4 rounded-r-2xl flex items-center justify-between ">
                    <div className="flex items-center gap-2">
                        <div className=" py-1.5 text-3xl lg:text-5xl rounded-full hidden lg:flex items-center justify-center">
                            <p>{emoji}</p>
                        </div>
                        <h2 className="text-sm flex flex-col items-start font-semibold text-black/50">DETECTED MOOD <span className="text-black text-sm lg:text-xl font-semibold capitalize">{expression}</span></h2>
                    </div>
                    {confidence !== null && (
